    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Hiển thị độ khẩn</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Hiển thị độ khẩn</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <form action="" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="trang_thai" disabled
                                    @if ($doKhan->trang_thai == 1) : value="Kích hoạt" @else value="Ngừng hoạt động" @endif>
                            </div>
                            <div class="form-group">
