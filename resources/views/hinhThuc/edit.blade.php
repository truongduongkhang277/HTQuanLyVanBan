    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Chỉnh sửa hình thức</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Chỉnh sửa hình thức</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        ...
                        @endif
                        <form action="{{ route('hinhThuc.update', $hinhThuc->id) }}" method="POST" role="form">
                            @csrf @method('PUT')                                    
                            @include('partials.alert')
                            <div class="form-group">
                                <label for="">Hình thức</label>
                                <input type="text" class="form-control" name="hinh_thuc"
                                    value="{{ $hinhThuc->hinh_thuc }}">
                                @error('hinh_thuc')
